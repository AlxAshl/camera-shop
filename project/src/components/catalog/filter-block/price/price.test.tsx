...
describe('Price component', () => {
  test('renders price inputs with no values and with placeholders', () => {
    renderWithProviders(<PriceBlock/>,{initialState: {PRODUCT: {products: productsMock}, FILTERS: { allProducts: productsMock, extraFilters:{PriceMax: [], PriceMin: []}}} , route: `${AppRoute.Catalog}/page_1`});
